...
-- Дополнительный трек для проверки условия с "my/мой"
INSERT INTO Track (title, duration, album_id) VALUES
('My Song', 240, 2);

-- Дополнительный альбом 2020 года для Linkin Park
INSERT INTO Album (title, release_year) VALUES
('Reanimation', 2020);

-- Связь альбома с исполнителем (Linkin Park, id=4)
INSERT INTO album_artist (album_id, artist_id) VALUES
(4, 4);

-- Пара треков для нового альбома
INSERT INTO Track (title, duration, album_id) VALUES
('My December', 250, 4),
('Pts.OF.Athrty', 200, 4);

-- Добавим эти треки в сборник Mixed Vibes (id=4)
INSERT INTO compilation_track (compilation_id, track_id) VALUES
(4, 7),
(4, 8);